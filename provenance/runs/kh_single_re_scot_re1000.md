...
projection, and direct-B PDE, vorticity, and current losses. The objective
applies time-local relative losses to every primary field and current density,
while vorticity uses global space-time relative L2.
